 ...
 * @author isabe
 */
@WebServlet(name = "JurosCompostoServlet", urlPatterns = {"/juros-compostos.html"})
public class JurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>JurosCompostoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                   ...
                   double result = vp * Math.pow((1+(j/100)), n);                    
                                  
                   out.println("<h4><b>Valor futuro com juros compostos:</b> " + result + "</h4>");                               
